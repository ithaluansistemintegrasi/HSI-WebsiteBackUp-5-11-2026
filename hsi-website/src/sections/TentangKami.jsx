        ...
        {loop.map((b, idx) => (
          <div key={`${b.name}-${idx}`} className="shrink-0">
            <a
              ...
              className={`flex h-16 w-[160px] items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 px-4 ${
                b.linkUrl ? "hover:bg-white" : "pointer-events-none"
              }`}
            >
              <img
                src={b.src}
    ...
    <section className="pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12">
          ...
          <div className="mt-6">
            <BrandMarquee items={partnerBrands} speed={22} />
          </div>
        </div>
